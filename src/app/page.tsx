...
const Blog = () => {
  return (
    <div className="flex flex-col bg-[#121214] w-full h-full justify-start items-center">
      <SearchBar />
      <div className="flex flex-col justify-center items-center mt-4 mb-4 space-y-4">
        {
